        ...
        let json = """
{
    ...
    "pr": {
        ...
        "pr_long": "広島出身のオーナーが「広島の味をもっと知ってほしい」との想いでオープンした当店。広島県民に愛され続けるお好み焼をはじめ、呉名物のがんす、肉厚な牡蠣など福岡にいながら広島を存分に味わえるメニューを揃えました。"
    },
    "code": {
        "areacode": "AREA140",
        "areaname": "九州",
...
"""
        ...
        XCTAssertEqual(shop.pr.prLong, "広島出身のオーナーが「広島の味をもっと知ってほしい」との想いでオープンした当店。広島県民に愛され続けるお好み焼をはじめ、呉名物のがんす、肉厚な牡蠣など福岡にいながら広島を存分に味わえるメニューを揃えました。")
